...
@Component({
  selector: 'app-request-contract-list-upload-document',
  templateUrl: './contract-list-upload-document.component.html',
  styleUrls: ['./contract-list-upload-document.component.scss']
})
export class ContractListUploadDocumentComponent implements OnChanges {
