...
@Component({
  ...
  providers: [
    DatePipe,
    {
      ...
      useExisting: forwardRef(() => ProposalParametersFormComponent),
      multi: true
    }
  ]
})
export class ProposalParametersFormComponent implements AfterContentInit, ControlValueAccessor, OnDestroy {
