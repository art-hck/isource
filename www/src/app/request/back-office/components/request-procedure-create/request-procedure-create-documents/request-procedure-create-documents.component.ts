...
@Component({
  ...
  templateUrl: './request-procedure-create-documents.component.html',
  styleUrls: ['./request-procedure-create-documents.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => RequestProcedureCreateDocumentsComponent),
    multi: true
  }]
})
export class RequestProcedureCreateDocumentsComponent implements AfterContentInit, ControlValueAccessor {
