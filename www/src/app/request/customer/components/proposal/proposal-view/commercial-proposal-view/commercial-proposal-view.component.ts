...
import { CommercialProposalComponent } from "../../commercial-proposal/commercial-proposal.component";
...
export class CommercialProposalViewComponent implements OnInit, OnDestroy, AfterViewInit {
  @ViewChildren('proposalOnReview') proposalsOnReview: QueryList<GridRowComponent | CommercialProposalComponent>;
