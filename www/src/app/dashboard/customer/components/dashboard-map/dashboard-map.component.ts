...
import { UxgIconService } from "uxg";
...
export class DashboardMapComponent implements OnInit {
  ...
  constructor(
    ...
    private iconService: UxgIconService,
    private cd: ChangeDetectorRef
  ) {}

  ngOnInit() {
    this.iconService.add({ "map-basis": `<svg viewBox="0 0 72 84" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M54 0H66L69 58H72V84H48H24H0V58L22 36H24V58L46 36H48V58H51L54 0ZM18 65V61H6V65H18ZM6 71V67H18V71H6ZM42 67H30V71H42V67ZM30 61H42V65H30V61Z"/></svg>` });
    this.iconService.add({ "map-contragent": `<svg viewBox="0 0 27 37" xmlns="http://www.w3.org/2000/svg"><path d="M27 13.2995C27 20.6447 13.5 37 13.5 37C13.5 37 -1.80481e-06 20.6447 -1.16268e-06 13.2995C-5.20551e-07 5.95441 6.04416 5.28397e-07 13.5 1.18021e-06C20.9558 1.83202e-06 27 5.95441 27 13.2995Z"/></svg>` });
    this.iconService.add({ "map-jiber-bus": `<svg width="44" height="44" viewBox="0 0 39 44" fill="none" xmlns="http://www.w3.org/2000/svg">
