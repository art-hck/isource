...
@Component({
  selector: 'app-agreements-deprecated',
  templateUrl: './agreements-deprecated.component.html',
  styleUrls: ['./agreements-deprecated.component.scss']
})
export class AgreementsDeprecatedComponent {
